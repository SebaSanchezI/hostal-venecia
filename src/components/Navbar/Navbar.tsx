...
import logoPath from "@assets/logo-venecia.png";
...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  const handleSendTo = (name: SocialMediaName) => {
    const url =
      name === SocialMediaName.INSTAGRAM
        ? SocialMediarUrl.INSTAGRAM
        : SocialMediarUrl.FACEBOOK;
  ...
  return (
    <>
      <AppBar
        sx={{ padding: { xs: "8px 16px", sm: "8px 16px", md: "0 16px" } }}
      >
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          >
            ...
            <IconButton
              size="large"
              onClick={() => {
                handleSendTo(SocialMediaName.INSTAGRAM);
              }}
              sx={{ marginLeft: "8px" }}
            >
            ...
            <IconButton
              size="large"
              onClick={() => {
                handleSendTo(SocialMediaName.FACEBOOK);
              }}
              sx={{ marginLeft: "8px" }}
            >
