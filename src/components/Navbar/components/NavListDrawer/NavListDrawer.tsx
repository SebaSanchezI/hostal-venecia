import {
  SocialMediaName,
  type NavItem,
} from "@components/Navbar/models/navbar.type";
import {
  Box,
  Divider,
  List,
...
const NavListDrawer: React.FC<NavListDrawerProps> = (props) => {
  const { listItems, location, color, onClick, sendSocialMediaFunction } =
    props;
      ...
      >
        ...
        >
          <IconButton
            size="large"
            onClick={() => {
              sendSocialMediaFunction(SocialMediaName.INSTAGRAM);
            }}
          >
          ...
          <IconButton
            size="large"
            onClick={() => {
              sendSocialMediaFunction(SocialMediaName.FACEBOOK);
            }}
          >
